/* ============================================
   NMDC LIMITED, BACHELI COMPLEX — Shared JavaScript
...
// ============================================
const AUTH_KEY = 'nmdc_auth';
const ROLES = { ADMIN: 'admin', IT_OFFICER: 'it_officer', READ_ONLY: 'read_only' };

const MOCK_USERS = [
  { empId: 'NMDC-BC-ADM-001', password: 'admin123', name: 'Shri R.K. Verma', role: ROLES.ADMIN, department: 'CS&IT', designation: 'GM (IT)' },
  { empId: 'NMDC-BC-IT-042', password: 'officer123', name: 'Smt. Priya Sharma', role: ROLES.IT_OFFICER, department: 'CS&IT', designation: 'Manager (Network)' },
  { empId: 'NMDC-BC-RO-100', password: 'viewer123', name: 'Shri A.K. Das', role: ROLES.READ_ONLY, department: 'CS&IT', designation: 'Assistant (IT)' }
];
...
function getNotifications() {
  return [
    ...
    { id: 3, type: 'asset', icon: '🖥️', title: 'Asset Updated', message: 'NMDC-BC-AST-1042 reassigned to Network Team, Bacheli', time: '1 hr ago', read: false },
...
const departmentDirectory = [
  { name: 'Network Team', head: 'Shri B.N. Prasad', designation: 'Manager (Network)', phone: 'Ext. 5101', email: 'network.bacheli@nmdc.co.in', members: 8 },
  { name: 'Server Team', head: 'Smt. Kavita Rao', designation: 'Manager (Server Admin)', phone: 'Ext. 5102', email: 'servers.bacheli@nmdc.co.in', members: 6 },
  { name: 'ERP Team', head: 'Shri D.K. Mohanty', designation: 'Manager (ERP)', phone: 'Ext. 5103', email: 'erp.bacheli@nmdc.co.in', members: 10 },
  { name: 'Helpdesk Team', head: 'Shri P. Lakshman', designation: 'Sr. Executive (Helpdesk)', phone: 'Ext. 5104', email: 'helpdesk.bacheli@nmdc.co.in', members: 12 },
  { name: 'Cyber Security Team', head: 'Shri V.S. Rajan', designation: 'Manager (Cyber Security)', phone: 'Ext. 5105', email: 'cybersec.bacheli@nmdc.co.in', members: 5 }
];

// ============================================
// AUDIT LOG (prepared for future Audit module)
// ============================================
const AUDIT_KEY = 'nmdc_audit_log';
...
// TICKET MANAGEMENT
// ============================================
const TICKETS_KEY = 'nmdc_tickets';
